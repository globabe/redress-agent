...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "A GenLayer demo for judging whether an AI purchase satisfied human intent." },
      { name: "author", content: "Lovable" },
      { property: "og:title", content: "Redress — Intent Adjudication" },
      { property: "og:description", content: "A GenLayer demo for judging whether an AI purchase satisfied human intent." },
